        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($requerimiento->des_requerimiento) ?></td>
                  <td class="actions">
                    <?= $this->Html->link(__('Ver'), ['action' => 'view', $requerimiento->requerimiento_id]) ?>
                    <?= $this->Html->link(__('Editar'), ['action' => 'edit', $requerimiento->requerimiento_id]) ?>
                    <?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $requerimiento->requerimiento_id], ['confirm' => __('¿Esta seguro que desea eliminar este registro?')]) ?>
                </td>
            </tr>
        <?php endforeach; ?>
        <tr>
