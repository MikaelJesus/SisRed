...
<?= $this->Form->create($recibido,['class'=>'form-horizontal']) ?>
          <fieldset>
            <legend><h1><?= __('Agregar Recibido') ?></h1></legend>
            <div class="form-group">
              <label for="recibido_id" class="col-lg-2 control-label">Clave</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" name="recibido_id" id="recibido_id" required="required" placeholder="Clave">
              </div>
            </div>
            <div class="form-group">
              <label for="des_recibido" class="col-lg-2 control-label">Descripcion</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" name="des_recibido" id="des_recibido" required="required" placeholder="Descripcion">
              </div>
            </div>
            <div class="form-group">
