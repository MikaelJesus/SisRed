...
<?= $this->Form->create($dependencia,['class'=>'form-horizontal']) ?>
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" name="dependencia_id" id="dependencia_id" placeholder="Clave">
      </div>
    </div>
    <div class="form-group">
      <label for="des_dependencia" class="col-lg-2 control-label">Descripcion</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" name="des_dependencia" id="des_dependencia"  placeholder="Descripcion">
      </div>
    </div>
    <div class="form-group">
