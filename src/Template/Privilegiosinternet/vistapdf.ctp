...
<form method="post" accept-charset="utf-8" class="form-horizontal" action="/SisRed/privilegiosinternet/pdf.pdf" target="_blank">
    <legend><h1><?= __('PDF') ?></h1></legend>
    <div class="form-group">
      <label for="privilegio_id" class="col-lg-2 control-label">Privilegio ID</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" name="privilegio_id" id="privilegio_id">
      </div>
    </div>
    <div class="form-group">
              <label for="nivel" class="col-lg-2 control-label">Nivel del Privilegio</label>
              <div class="col-lg-10">
                <?php echo $this->Form->control('nivel',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            <div class="form-group">
              <label for="des_privilegio" class="col-lg-2 control-label">Descipcion</label>
              <div class="col-lg-10">
