    ...
    <ul class="sidebar-nav">
      ...
      <li><?= $this->Html->link(__('Lista de Empleados'), ['action' => 'index']) ?></li>
        ...
        <!-- <div id="page-content-wrapper">
          ...
          <fieldset>
            <legend><h1><?= __('Editar Empleado') ?></h1></legend>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('nup',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('apellidop',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('apellidom',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('curp',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('rfc',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('fecha_gafete',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
              ...
              <div class="col-lg-10">
                <select class="form-control" name="sexo" id="sexo">
                    ...
                    if ($empleado->sexo == "Masculino") {
                        echo "<option value='Masculino' selected='selected'>Masculino</option> <option value='Femenino'>Femenino</option>";
                    } else{
                        echo "<option value='Masculino'>Masculino</option> <option value='Femenino' selected='selected'>Femenino</option>";
                    }
                    ?>
                </select>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('statusprofecional_statusprofecional_id', ['label'=>false,'options' => $status,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('domicilio',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('telefono_local',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('telefono_celular',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('observaciones',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('clave_imss',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('nombre_emergencia',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('apellidop_emergencia',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('apellidom_emergencia',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('tel_emergencia',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('tipo_sangre',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <?php echo $this->Form->control('alergias',['label'=>false,'class'=>'form-control']);?>
              </div>
            </div>
