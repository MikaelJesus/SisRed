...
<div id="buscar" style="display: none;">
    <h1><?= __('Buscador') ?></h1>
<?php
   echo $this->Form->create(null, ['valueSources' => 'query','class'=>'form-group']);
    // You'll need to populate $authors in the template from your controller
    // Match the search param in your table configuration
    echo $this->Form->input('nue',['class'=>'form-control']);
    echo $this->Form->button('Buscar', ['type' => 'submit','class'=>'btn btn-default']);
