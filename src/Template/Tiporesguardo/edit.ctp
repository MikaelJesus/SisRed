...
<nav class="large-2 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tiporesguardo->tiporesguardo_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tiporesguardo->tiporesguardo_id)]
            )
        ?></li>
...
<div class="tiporesguardo form large-10 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Tiporesguardo') ?></legend>
        <?php
